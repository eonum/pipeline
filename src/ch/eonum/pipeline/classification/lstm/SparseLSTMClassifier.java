...
public class SparseLSTMClassifier<E extends SparseSequence> extends SparseLSTM<E> {
	private boolean targetSequence = false;
	
	public SparseLSTMClassifier(){
		super();
		classify = true;
	}
	...
	protected SparseLSTMCore<E> createNet(String name, String folder, int seed) {
		SparseLSTMCore<E> core = new SparseLSTMCore<E>(name, folder, this, seed, outputGates, forgetGates, inputGates, dropout);
		if(this.trainInParallel)
			core.trainInParallel();	
